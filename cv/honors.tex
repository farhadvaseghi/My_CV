...
%---------------------------------------------------------
  \cvhonor
    {Elite student} % Award
    {Entering master's degree directly without domestic qualification exam.} % Event
...
%---------------------------------------------------------
  \cvhonor
    {Elite student} % Award
    {Received national undergraduate full scholarship.} % Event
    {Isfahan, Iran} % Location
    {2017} % Date(s)

%---------------------------------------------------------
  \cvhonor
    {Konkour(Iranian University Entrance Exam)} % Award
    {Ranked 820 among more than 500,000 participants for the university entrance.} % Event
    {Isfahan, Iran} % Location
    {2017} % Date(s)
